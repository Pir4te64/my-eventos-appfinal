  ...
  return (
    ...
    >
      <div className="flex flex-col items-center w-full flex-1 justify-center">
        <h3 className={`font-semibold text-green-800 mb-2 flex items-center justify-center ${loc.nombre.length > 22 ? 'text-sm' : 'text-base'}`} style={{textAlign:'center', wordBreak:'break-word'}}>{loc.nombre}</h3>
        <div className="text-xs text-gray-600 mb-2 flex items-center justify-center w-full"><FaMapMarkerAlt className="inline mr-1" />{loc.direccion}</div>
      </div>
