  ...
  return (
    ...
    >
      <div className="flex flex-col items-center w-full">
        <h3 className="text-xl font-semibold text-green-800 mb-2 flex items-center justify-center"><FaBuilding className="mr-2" />{bar.nombre}</h3>
        <div className="text-sm text-gray-600 mb-2 flex items-center justify-center w-full"><FaMapMarkerAlt className="inline mr-1" />{bar.direccion}</div>
      </div>
