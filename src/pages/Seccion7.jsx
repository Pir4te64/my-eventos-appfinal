  ...
  return (
    <div className="font-source">
      ...
      <section className="relative max-w-7xl mx-auto mt-8 h-[400px] overflow-hidden rounded-2xl">
        <img src="/universitariaweb.png" alt="Banner" className="absolute inset-0 w-full h-full object-cover opacity-90 hidden md:block" />
        <img src="/universitariamobile.png" alt="Banner" className="absolute inset-0 w-full h-full object-cover opacity-90 md:hidden" />
        <div className="relative z-10 flex flex-col justify-center items-center h-full px-6 text-center text-white">
          <span className="text-sm uppercase tracking-widest font-medium opacity-90">Educación Superior</span>
          <h1 className="mt-4 text-4xl md:text-5xl font-bevietnam font-bold">Posadas Universitaria</h1>
          <p className="mt-4 text-lg max-w-2xl mx-auto opacity-90">Centro académico y de innovación con amplia oferta educativa y eventos universitarios.</p>
        </div>
      </section>
      ...
      >
        <h2 className="text-2xl font-semibold text-center text-gray-900 mb-8">Catálogo de Sedes Académicas</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {sedesFiltradas.length === 0 ? (
            <div className="col-span-full text-center py-8 text-gray-500">No se encontraron sedes académicas.</div>
          ) : (
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span className="block text-xs text-gray-600 text-center font-medium mb-2">
                      {sede.tipo ? sede.tipo : sede.direccion}
                    </span>
