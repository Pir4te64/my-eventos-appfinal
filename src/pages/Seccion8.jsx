  ...
  return (
    <div className="font-source">
      ...
      <section className="relative max-w-7xl mx-auto mt-8 h-[400px] overflow-hidden rounded-2xl">
        <img src="/bureauweb.png" alt="Banner" className="absolute inset-0 w-full h-full object-cover opacity-90 hidden md:block" />
        <img src="/bureaumobile.png" alt="Banner" className="absolute inset-0 w-full h-full object-cover opacity-90 md:hidden" />
        <div className="relative z-10 flex flex-col justify-center items-center h-full px-6 text-center text-white">
          <span className="text-sm uppercase tracking-widest font-medium opacity-90">Bureau Oficial</span>
          <h1 className="mt-4 text-4xl md:text-5xl font-bevietnam font-bold">Posadas Congresos y Convenciones Bureau</h1>
          <p className="mt-4 text-lg max-w-2xl mx-auto opacity-90">
            Impulsando el turismo de reuniones y eventos de alto nivel en la ciudad.
          </p>
        </div>
      </section>
          ...
          <div className="bg-white rounded-xl p-8 mb-12 border border-gray-100">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <h4 className="text-base font-semibold text-gray-900 mb-2">Asesoramiento Integral</h4>
                <p className="text-gray-600 text-sm">
              ...
              >
                ...
                <h4 className="text-base font-semibold text-gray-900 mb-2">Logística y Transporte</h4>
                <p className="text-gray-600 text-sm">
              ...
              >
                ...
                <h4 className="text-base font-semibold text-gray-900 mb-2">Marketing y Promoción</h4>
                <p className="text-gray-600 text-sm">
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    aria-expanded={open}
                  >
                    <span className="block text-sm font-semibold text-gray-900 text-center mb-1">{socio.nombre}</span>
                    <span className="block text-xs text-gray-600 text-center font-medium mb-2">{socio.rubro}</span>
                    ...
                    {open && (
                      <div className="w-full px-4 space-y-2">
                        <div className="text-xs text-gray-700">
                          <span className="font-semibold">Persona de Contacto:</span> {socio.contacto}
                        </div>
                        <div className="text-xs text-gray-700">
                          <span className="font-semibold">Mail de Contacto:</span> 
                          <a href={`mailto:${socio.email}`} className="text-green-700 underline ml-1">
                            {socio.email}
                          </a>
                        </div>
                      </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <a 
                  ...
                  className="inline-flex items-center bg-white text-green-800 px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition-colors text-sm"
                >
